...
emits a JSON at equissl-workspace/data/equissl_measurements_<date>.json following
...
STAGING = Path("./work/phase2_staging")
...
def main():
    ...
    if args.out:
        ...
        out = Path("./work/equissl-workspace/data") / f"equissl_measurements_{date.today().isoformat()}.json"
